        ...
        <span
          ...
          {firstState && (
            <div className="form bg-purple-700 rounded-lg p-5">
              <p class="font-normal text-white dark:text-white capitalize text-justify">
                ...
                JWT and much much more. <br /> For The Eligibility You Have To
                Creat A Video And Tag Us On The Linked In For Quality Check And
                Assurence Of Completion
              </p>
              ...
              <div className="pt-2">
                ...
                <input
                  ...
                  class="bg-gray-50 border border-gray-300 text-purple-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-500 dark:placeholder-purple-700 dark:text-white"
                  required
                />
              </div>
